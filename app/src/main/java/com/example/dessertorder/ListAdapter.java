...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView
        ...
        listViewHolder.btnPlus.setOnClickListener(v -> updateQuantity(position,listViewHolder.edTextQuantity,1));
        //listViewHolder.edTextQuantity.setText("0");
        listViewHolder.btnMinus.setOnClickListener(v -> updateQuantity(position,listViewHolder.edTextQuantity,-1));
